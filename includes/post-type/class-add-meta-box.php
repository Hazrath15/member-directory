...
if( !class_exists('MEDIR_Add_Meta_Box') ) {
    class MEDIR_Add_Meta_Box {
        ...
        use MEDIR_User_Email_Render_Helper;
        ...
        function medir_add_member_meta_boxes() {
            ...
            add_meta_box('medir_member_messages','Contact Messages',[$this, 'medir_render_member_messages_box'],'medir_member','normal','default');
        }
    }
}
?>