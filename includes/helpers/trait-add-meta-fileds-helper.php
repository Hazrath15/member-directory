...
trait MEDIR_Add_Meta_Fields_Helper {
    function medir_member_fields($post) {
        ...
        ?>
        <p><label>First Name: <input type="text" name="medir_first_name" value="<?php echo esc_attr($first_name); ?>"></label></p>
        <p><label>Last Name: <input type="text" name="medir_last_name" value="<?php echo esc_attr($last_name); ?>"></label></p>
