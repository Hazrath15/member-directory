...
<div class="member-details-area">
    <div class="member-details">
        <h1><?= esc_html($first . ' ' . $last) ?></h1>
        <p>Email: <?= esc_html($email) ?></p>
        <p>Favorite Color: <span style="color:<?= esc_attr($color) ?>">■</span></p>
    </div>
    <div class="contact-form">
        <form method="post" action="">
            ...
            <input type="hidden" name="to_email" value="<?= esc_attr($email) ?>">
